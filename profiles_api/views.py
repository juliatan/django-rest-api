...
class HelloApiView(APIView):
    ...
    def put(self, request, pk=None):
        """Handle updating an object. pk = primary key i.e. likely to be the ID of the object to be updated. In this case, we won't be using it."""
...
class UserProfileFeedViewSet(viewsets.ModelViewSet):
    ...
    # Here, we are passing in an additional keyword for user_profile.
    def perform_create(self, serializer):
        """Sets the user profile to the logged in user"""
        serializer.save(user_profile=self.request.user) # the user is appended to request since we use TokenAuthentication